...
public class MergeSort {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Unsorted array:%n%s%n%n", Arrays.toString(data)); // display unsorted array
		
		mergeSort(data);
		
		System.out.printf("Sorted array: %n%s%n%n", Arrays.toString(data)); // display sorted array
	}
