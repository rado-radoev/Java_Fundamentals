...
public class PasswordPrompt
{
    ...
    public PasswordPrompt() extends JFrame {
      ...
      bold.addItemHandler(checkBoxHandler);
      bold.addItemHandler(checkBoxHandler);
    ...
    private class PasswordFieldPainter implements ActionListener {
      @Override
      public void actionPerform(ActionEvent event) {
    ...
    private class ButtonHandler implements ActionListener {
      @Override
      public void actionPerform(ActionEvent event) {
        JOptionPane.showMessageDialog(PasswordPrompt.this, "You pressed " + getSource());
      }
    } // end ButtonHandler
