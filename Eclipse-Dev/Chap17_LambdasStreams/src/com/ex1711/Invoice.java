...
public class Invoice implements Payable
{
   ...
   public String toString() {
	   return String.format("%-10s%30s%15d%15.2f", getPartNumber(), getPartDescription(), getQuantity(), getPricePerItem());
   }
...
public class Invoice implements Payable
{
   ...
   @Override
   public String toString() {
	   return String.format("%d %s %d %.2f", getPartNumber(), getPartDescription(), getQuantity(), getPricePerItem());
   }
